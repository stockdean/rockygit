        ...
        if (canvas.toDataURL) {
            ...
            saveCB = function(data) {
                ...
                if (pos >= 4 * w * h) {
                    ...
                    $.ajax({
			             type: "post",
			             url: "/MicroTasks/CatD?t="+new Date().getTime(),
...
<div class="btn">
    ...
    <input type="button" value="保存" id="saveBtn" onclick="savePhoto();"/>
    <a href="/MicroTasks/">完成注册</a>
</div>
<%-- <div id="photos">
	<img src="/MicroTasks/User/<%=guestid %>/profile/<%=guestid %>.png" id="img" >
</div> --%>
  </body>
</html>
